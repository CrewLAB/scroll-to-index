...
mixin AutoScrollControllerMixin on ScrollController implements AutoScrollController {
  ...
  Future _scrollToIndex(
    ...
    if (isIndexStateInLayoutRange(index)) {
      ...
      await _bringIntoViewportIfNeed(index, preferPosition, beginningPadding, (double offset) async {
  ...
  Future _bringIntoViewportIfNeed(
    ...
    if (preferPosition != null) {
      ...
      final begin = _directionalOffsetToRevealInViewport(index, 0, beginningPadding);
      final end = _directionalOffsetToRevealInViewport(index, 1, beginningPadding);
  ...
  double _directionalOffsetToRevealInViewport(int index, double alignment, double? beginningPadding) {
    ...
    if (tagOffsetInViewport == null) {
      ...
      if (alignment == 0.5) {
        ...
        return absoluteOffsetToViewport - (beginGetter(viewportBoundaryGetter()) + (beginningPadding ?? 0));
      } else {
